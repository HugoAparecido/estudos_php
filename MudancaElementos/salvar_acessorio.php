...
$query_acessorio = "INSERT INTO carro_acessorio (acessorio_id, carro_id) VALUES (:acessorio_id, :carro_id)";
// Preparar a QUERY
...
if ($cad_acessorio->execute()) {
    ...
    echo json_encode(['status' => false, 'mensagem' => 'Errro: Acessório não salvo!']);
}
